				  ...
				  <tr>
					...
					<td>
					  <div class="am-btn-toolbar">
						<div class="am-btn-group am-btn-group-xs">
						@if ($articleInfo['isPublished'])
						  <button type="button" onclick="deleteTie({{ $articleInfo['id'] }})" class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</button>
						@else
						  <button type="button" onclick="publishTie({{ $articleInfo['id'] }})" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 发布</button>
						@endif
						</div>
					  </div>
					</td>
