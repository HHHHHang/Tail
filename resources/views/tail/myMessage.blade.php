        ...
        <div class="col-md-8">
            ...
            <div class="well">
                <ul class="nav nav-pills" style="font-size: large;">
                    <li role="presentation"><a href="#post" data-toggle="pill">我的帖子</a></li>
                    ...
                    <li class="active"><a href="#myMessage" data-toggle="pill">我的消息</a></li>
                </ul>
                <br/>
                <hr/>
                <br/>
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade in active" id="myMessage">
